...
import { ArrowUpRight, ArrowDownRight, Wallet, Users, ArrowRightLeft, Gift } from "lucide-react";
import { formatCurrency } from "@/lib/utils";
import { useGetDashboardMetrics, useGetTransactionTrends } from "@workspace/api-client-react";
...
export default function Dashboard() {
  ...
  const metricsRaw = (metricsData && !metricsError) ? metricsData : MOCK_METRICS;
  const metrics = {
    ...MOCK_METRICS,
    ...(metricsRaw && typeof metricsRaw === "object" ? metricsRaw : {}),
  };
  const trendsRaw = (trendsData && !trendsError) ? trendsData : MOCK_TRENDS;
  const trends = Array.isArray(trendsRaw) ? trendsRaw : MOCK_TRENDS;
    ...
    <Layout title="Dashboard Overview">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <MetricCard 
          ...
          value={Number(metrics.dailyTransactions ?? 0).toLocaleString()} 
